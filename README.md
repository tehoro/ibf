...
> Gordon, Neil. *IBF (Impact-Based Forecast Toolkit): LLM-assisted generation of impact-based weather forecasts* (v0.6.0). 2026. [https://github.com/tehoro/ibf](https://github.com/tehoro/ibf)
